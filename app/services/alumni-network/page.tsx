...
import { Users, ExternalLink, Lock, ArrowRight, Briefcase, GraduationCap, Calendar } from "lucide-react"
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pt-20">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-12 text-center">
          <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">UBIT Alumni Network</h1>
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Connect with fellow graduates, share opportunities, and stay updated with the UBIT community.
          </p>
        </div>
        ...
        <section className="mb-16">
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Alumni Groups</h2>
            <Link
              href="/services/alumni-network/groups"
