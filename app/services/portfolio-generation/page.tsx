...
const subcategories = [
  {
    ...
    description: "Choose from various templates for your professional portfolio",
  ...
  },
  {
    ...
    image: "/placeholder.svg?height=400&width=400",
    href: "/services/portfolio-generation/guidelines",
  },
  // {
  //   title: "Digital Showcase",
  //   description: "Showcase your work in an interactive digital format",
  //   image: "/placeholder.svg?height=400&width=400",
  //   href: "/services/portfolio-generation/digital-showcase",
  // },
  // {
  //   title: "Portfolio Review",
  //   description: "Get feedback on your portfolio from professionals",
  //   image: "/placeholder.svg?height=400&width=400",
  //   href: "/services/portfolio-generation/review",
  // },
]
  ...
  return (
    <div className="min-h-screen bg-black pt-24 pb-16">
      ...
      <div className="container-custom py-12">
        ...
        <h1 className="text-4xl font-bold text-primary mb-4">Portfolio Generation</h1>
        <p className="text-lg text-white mb-12 max-w-3xl">
          Create and manage professional portfolios to showcase your work
        </p>
