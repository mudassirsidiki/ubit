...
import { Search, Filter, PlusCircle, BookOpen, ShoppingBag } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pt-20">
      <div className="container mx-auto px-4 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Buy & Sell Books</h1>
          <p className="text-gray-600 dark:text-gray-300">
            Find textbooks from fellow students or sell your used books to those who need them.
          </p>
        </div>
