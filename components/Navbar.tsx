...
export default function Navbar() {
  ...
  const services = [
    ...
    { name: "Blogs", href: "/services/blogs", restricted: false },
    { name: "Alumni Network", href: "/services/alumni-network", restricted: true },
    { name: "Events", href: "/services/events", restricted: false },
      ...
      <div className="container-custom flex justify-between items-center">
        ...
        <button onClick={handleHomeClick} className="flex items-center gap-3" aria-label="Go to homepage">
          <div className="relative w-10 h-10 bg-white dark:bg-gray-800 rounded-full p-1">
            <Image src="/ubit-logo.png" alt="UBIT Logo" fill className="object-contain dark:hidden" />
            <Image src="/ubit-logo-white.png" alt="UBIT Logo" fill className="object-contain hidden dark:block" />
          </div>
          <span
